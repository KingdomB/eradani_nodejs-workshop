...
* [repl.it Setup](#replit-setup)
    * [Example repli.it Setup](#example-replit-setup)
...
* **Windows**
    * // TODO: This might be easier through ACS
...
Setting up the IBM i to use Node.js is not a difficult process with basic Unix skills, but can be challenging for IBM i developers who are used to the OS400 way of doing things. If you have gotten through the setup process, pat yourself on the back and know then you have nothing but learning ahead of yourself! Continue onto learning JavaScript, or if you came from the Express.js page, [click this link to go back to that page](./5.express.js.md).
