...
At the beginning of the workshop, we will be using a website called repl.it to get our feet wet with JavaScript and become familiar with Node.js. This will allow us to avoid the boring setup part of the workshop until after we have done something interesting. The JavaScript and Node.js skills you will gain and the code you will write on repl.it will be the exact same as those that you will use on your IBM i. If you are walking through the lab instructions after the day of the lab, feel free to skip ahead to the IBM i setup instructions.

The setup instructions for using repl.it can be found [here](#repl.it-setup).
...
### **Mounting your PASE home directory onto your PC/Mac/Linux**
