...
There are many functions that come prebuilt in arrays. These include functions to remove indecies from the array and shift all values accordingly, find values in arrays and return their indecies, pop values from or push values to the end of an array, and many more.
